...
extern ADC14_TypeDef ADC14_STRUCT;      //ADC14结构体
#define ADC14_REF         3.3//参考电压
#define ONECE_CVRT_MOD    0x00//单次转换
#define REPEAT_CVRT_MOD   0x01//重复转换

extern void ADC14_convert_enable(void);//使能AD14转换
extern void ADC14_convert_disable(void);//禁能AD14转换
extern void ADC14_convert_start(void);
extern void ADC14_convert_end(void);
