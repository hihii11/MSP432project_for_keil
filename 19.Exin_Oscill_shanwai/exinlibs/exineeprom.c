...
//联合体声明
union int_chr   int_chr_convertor;//整形与字符型数据转换
union flt_chr   flt_chr_convertor;//浮点型与字符型数据转换
union dub_chr   dub_chr_convertor;//双精度浮点型与字符型数据转换
union short_chr short_chr_convertor;//短整形与字符型数据转换
