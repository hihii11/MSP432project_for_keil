...
extern union int_chr int_chr_convertor;//整形与字符型数据转换
extern union flt_chr flt_chr_convertor;//浮点型与字符型数据转换
extern union dub_chr dub_chr_convertor;//双精度浮点型与字符型数据转换
extern union short_chr short_chr_convertor;//短整形与字符型数据转换

extern void EROM_IIC_init(void);
extern void EROM_IIC_start(void);
extern void EROM_IIC_stop(void);
extern void EROM_IIC_ACK(void);
extern void EROM_IIC_NACK(void);
extern unsigned char EROM_Check_ACK(void);

extern void EROM_IIC_Send_Byte(uint8 Data);
extern unsigned char EROM_IIC_Read_Byte(uint8 ack);
extern void EEPROM_init(void);
extern void EEPROM_reset(void);//软件复位
