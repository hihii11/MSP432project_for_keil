 ...
 * 注意事项:无
 *************************************************/
void ADC14_convert_enable(void)//使能AD14转换
{
 ...
 * 注意事项:无
 *************************************************/
void ADC14_convert_disable(void)//禁能AD14转换
{
 ...
 *************************************************/
void ADC14_repeatmod_rec(int * BUF,ADC14_CHA_eunm ADC14_CHA)
{
    int i ;
